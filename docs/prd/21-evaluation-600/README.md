...
- **v0.3 — 2026-08-19** — `GOLD-01` delivered. **D21**/**D22** now name the allocated ADR number,
  **[ADR 0003 — Blind gold sealing, isolation and key custody](../../adr/0003-blind-gold-sealing.md)**,
  which records plan §8 **Q6** rather than reopening it (`0001` and `0002` were already taken, `0002`
