/**
 * FND-09 — the source scanner shared by `money-purity.test.ts` and `purity.test.ts`.
 *
 ...
 *
 * It strips COMMENTS *and* STRING LITERALS, which the sibling leaves' scanners do not need to. This
 * leaf must be able to say `'./micro-aud.js'` without that looking like a division, and to carry the
 * PRD's own `A$14–15` cells without those digits looking like float money.
 */
