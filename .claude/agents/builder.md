...
<!-- Model/effort pinned per pattern three-agent-architect-builder-reviewer, as of 2026-07-26.
     ...
     Live again as of 2026-08-11 (human-authorized), after an A/B comparison on ticket DATA-02
     in which both builders escalated at review after two bounce cycles (Codex: 3 findings;
     Claude: 4). The Claude-implementer variant is preserved at `.claude/agents/builder-claude.md`
     (inert: renamed so it cannot be resolved as `builder`). -->
