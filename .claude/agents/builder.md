...
<!-- Model/effort pinned per pattern three-agent-architect-builder-reviewer, as of 2026-07-26.
     ...
     medium. The previous Codex-delegating definition is preserved verbatim at
     `.claude/agents/builder-codex.md` (inert: renamed so it cannot be resolved as `builder`).
